...
app.post('/api/activate', (req, res) => {
    try {
        ...
        const userId = `locket_${timestamp}_${randomStr}`;
    ...
    <script>
        async function activatePremium() {
            ...
            try {
                ...
                if (data.success) {
                    resultDiv.innerHTML = '<div class="success">✅ ACTIVE THÀNH CÔNG!</div>' +
                        '<div class="info-box">' +
                        ...
                        '<strong>💡 Lưu ý:</strong> Server tự động xử lý tất cả. Bạn không cần làm gì thêm!' +
                        '</div>';
                } else {
                    resultDiv.innerHTML = '<div style="color: #ef4444; font-weight: bold;">❌ LỖI</div>' +
                ...
                loader.style.display = 'none';
                resultDiv.style.display = 'block';
                resultDiv.innerHTML = '<div style="color: #ef4444;">❌ Lỗi kết nối</div>' +
                    '<p>' + error.message + '</p>' +
                    '<p style="font-size: 14px; color: #666;">Kiểm tra kết nối internet và thử lại.</p>';
            }
        }
